...
export default function HomeroomMonitor() {
  const homeroomClass = 'XII IPA 1'; // Kelas perwalian default
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500">Pantau kehadiran siswa hari ini.</p>
        </div>
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>
                {selectedClass === homeroomClass ? 'Ini adalah kelas perwalian Anda.' : 'Memantau kelas lain.'} Update terakhir: Hari ini, 07:30 WIB
              </CardDescription>
            </div>
            {selectedClass === homeroomClass && (
              <Badge className="bg-emerald-100 text-emerald-800 hover:bg-emerald-100">Kelas Anda</Badge>
            )}
          </div>
        </CardHeader>
        <CardContent>
